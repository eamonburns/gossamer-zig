...
pub const TCC0 = extern struct {
    ...
    /// Compare and Capture
    /// offset: 0x44
    CC0: mmio.Mmio(packed struct(u32) {
    ...
    /// Compare and Capture
    /// offset: 0x48
    CC1: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Value
        CC: u24 = 0x0,
        padding: u8 = 0,
    }),
    /// Compare and Capture
    /// offset: 0x4c
    CC2: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Value
        CC: u24 = 0x0,
        padding: u8 = 0,
    }),
    /// Compare and Capture
    /// offset: 0x50
    CC3: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Value
        CC: u24 = 0x0,
        padding: u8 = 0,
    }),
    ...
    /// offset: 0x70
    CCBUF0: mmio.Mmio(packed struct(u32) {
    ...
    /// Compare and Capture Buffer
    /// offset: 0x74
    CCBUF1: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Buffer Value
        CCBUF: u24 = 0x0,
        padding: u8 = 0,
    }),
    /// Compare and Capture Buffer
    /// offset: 0x78
    CCBUF2: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Buffer Value
        CCBUF: u24 = 0x0,
        padding: u8 = 0,
    }),
    /// Compare and Capture Buffer
    /// offset: 0x7c
    CCBUF3: mmio.Mmio(packed struct(u32) {
        /// Channel Compare/Capture Buffer Value
        CCBUF: u24 = 0x0,
        padding: u8 = 0,
    }),
