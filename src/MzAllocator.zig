//! Freestanding allocator from microzig, with a few changes to be usable
//! outside of microzig.
//!
//! Source: https://github.com/ZigEmbeddedGroup/microzig/raw/refs/tags/0.17.9/core/src/allocator.zig
//! Commit: e06b41ba2816a6bebb9d785a03ff02a9f5f0adcb
//!
//! For the full list of changes, run the following command:
//!
//!     diff <(wget -O- https://github.com/ZigEmbeddedGroup/microzig/raw/refs/tags/0.17.9/core/src/allocator.zig) MzAllocator.zig
...
pub fn heap(reserve: usize) []u8 {
    const heapPtr: [*]u8 = @ptrCast(&_end);
    const heap_len: usize = @intFromPtr(&_stack_top) - @intFromPtr(&_end) - reserve;
